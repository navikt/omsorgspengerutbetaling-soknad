...
import {ListeMedBarnResponse} from "@navikt/omsorgspengerutbetaling-schema/lib/typescript/@types/barn";

export const getBarn: () => Promise<AxiosResponse<ListeMedBarnResponse>> = () => axios.get(getApiUrlByResourceType(ResourceType.BARN), axiosConfig);
